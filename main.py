from app.search import OneStepLookahead
...
def main() -> None:
    ...
    initial_state = TSPState(visited=[0], current_city=0, dist=dist_matrix, num_city=N)
    one_step_search = OneStepLookahead(initial_state)
